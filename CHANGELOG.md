...
- UnitySetupV2 updated to v2.0.2. [Full Changelog](https://github.com/Dinomite-Studios/unity-azure-pipelines-tasks/blob/master/Tasks/UnitySetup/UnitySetupV2/CHANGELOG.md).
