...
export class UnityEditorConfiguration {
    public static run(): number {
        ...
        if (installAndroidModule && installAndroidChildModules && configureAndroidTooling) {
            ...
            UnityPackageManagerTools.addPackageToProject(temporaryProjectPath, 'games.dinomite.azurepipelines', 'https://github.com/Dinomite-Studios/games.dinomite.azurepipelines.git#v1.0.14');
